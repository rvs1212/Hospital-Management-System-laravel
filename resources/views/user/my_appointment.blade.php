...
<body>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupport">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" style="background-color:#00cec9;color:black" href="{{'myappointment'}}">My Appointment</a>
            </li>
            <x-app-layout>
            </x-app-layout>
  ...
  <div align="center" style="padding:70px;">
    ...
    <table>
        ...
        <tr style="background-color:#c4dfdf;" align="center">
            ...
            <td style="padding: 10px;"><a class="btn btn-danger" onclick="return confirm('Are you sure delete this?')" href="{{url('cancel_appoint',
             $appoints->id)}}">Cancel</a></td>
        </tr>
